...
--vim.opt.scroll = 15
--vim.api.nvim_create_autocmd('BufWinEnter', { pattern = { '*' }, command = 'set scroll=15' })
...
vim.keymap.set('t', '<C-kMultiply>', '<C-\\><C-n>', { desc = 'Exit terminal mode' })
vim.keymap.set('n', 'gc', 'Vgc<CR>')
...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>so', require('fzf-lua').oldfiles, { desc = '[S]earch Recent Files ("." for repeat)' })
    ...
    config = function()
      ...
      vim.api.nvim_create_autocmd('LspAttach', {
        ...
        callback = function(event)
          ...
          if vim.bo.filetype ~= nil and vim.bo.filetype == 'cs' then
            map('gd', require('omnisharp_extended').telescope_lsp_definitions, '[G]oto definition for omnisharp/csharp')
          else
      ...
      require('mason-lspconfig').setup {
        handlers = {
          function(server_name)
            ...
            server.capabilities.format_on_save = false
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      format_on_save = function(bufnr)
        ...
        local disable_filetypes = { c = true, cpp = true, c_sharp = true }
        return {
          timeout_ms = 500,
        ...
        dependencies = {
          ...
          --    https://github.com/rafamadriz/friendly-snippets
          {
            ...
            config = function()
              ...
              require('luasnip.loaders.from_vscode').load { paths = { vim.fn.stdpath 'config' .. '/custom-snippets' } }
            end,
          },
        },
      },
